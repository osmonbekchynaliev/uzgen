...
<div class="content content-full">
          ...
          <div class="row text-center">
            <div class="col-6 col-xl-12">
              <!-- New Post -->
              <a class="block block-rounded" href="/DashBoard/news/create">
                <div class="block-content block-content-full">
                  <div class="py-md-3">
                    ...
                    <p class="fs-4 fw-bold mb-0">
                      <i class="fa fa-plus text-primary me-1 d-md-none"></i> Жаңылык түзүү
                    </p>
          ...
          <div class="block">
            <div class="block-header block-header-default">
              <h3 class="block-title">Жаңылыктардын тизмеси</h3>
            </div>
                  ...
                  <?foreach ($news as $key => $new):?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="/DashBoard/news/show?id=<?echo $new[0];?>">
                          <?echo $new[1];?>
                        </a>
                      </td>
                      ...
                      <td class="text-center">
                        <a class="btn btn-sm btn-alt-secondary" href="/DashBoard/news/edit?id=<? echo $new[0];?>">
                          <i class="fa fa-fw fa-pencil-alt text-primary"></i>
                        </a>
                        <a class="btn btn-sm btn-alt-secondary" href="/DashBoard/news/delete?id=<? echo $new[0];?>">
