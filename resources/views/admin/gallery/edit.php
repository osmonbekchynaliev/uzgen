              ...
              <div class="block-content">
                <div class="row justify-content-center push">
                  <div class="col-md-10">
                    ...
                    <div class="mb-4">
                      <label class="form-label" for="dm-post-add-title">Категориянын кыскача аты</label>
                      <input type="text" name="title" class="form-control" id="dm-post-add-title"  value="<?echo $blocks[1]?>" placeholder="Менюнун атын кийириңиздер..">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="dm-post-add-excerpt">Категориянын толук аты</label>
                      <textarea class="form-control"   id="dm-post-add-excerpt" name="long_title" rows="2" placeholder="Категориянын толук атын кийириңиздер.."><?echo $blocks[2]?></textarea>
                      <div class="form-text">Категориянын толук аты.</div>
                    </div>
                    <div class="mb-4">
                      <label class="form-label">Толук текст</label>
                      <textarea id="js-ckeditor" name="text"><?echo $blocks[3]?></textarea>
                    </div>
                    <div class="row mb-4">
                      <div class="col-xl-6">
